...
//controller for removing course/courses for a faculty
...
//controller for retrieve list of students enrolled in your course for a specific academic semester and course section [for faculty]
